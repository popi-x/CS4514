...
class UiLayout(object):
    def setupUiLayout(self, mainWindow):
        ...
        self.penAct = QAction(QIcon('icons/pen.png'), 'Pen', self)
        self.drawAct = QAction(QIcon('icons/draw.png'), 'Draw', self)
        self.eraseAct = QAction(QIcon('icons/eraser.png'), 'Erase', self)
        self.undoAct = QAction(QIcon('icons/undo.png'), 'Undo', self)
        self.redoAct = QAction(QIcon('icons/redo.png'), 'Redo', self)
        self.clearAct = QAction(QIcon('icons/clear.png'), 'Clear', self)
